...
program
    ...
    .action(async (options) => {
        ...
        process.env.CORS_ORIGIN = "https://reex-api.vercel.app,http://localhost:5173,http://localhost:3000,http://localhost:4000";
        ...
        const uiUrl = `http://localhost:3000?localPort=${port}`;
        console.log(`\n🌐 Opening UI: ${uiUrl}`);
        await open(uiUrl);
